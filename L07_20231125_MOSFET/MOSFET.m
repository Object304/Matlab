...
%
%%n=2:NN-1;
prl(2:0.4*NN-1) = sin(2*pi*(2:0.4*NN-1)/lambda);
...
while count < 4
    ...
    if n_step == 1
        PE = 0.;
        psi = prl + 1i*pim;    % Write as a complex function
        %psi = psi(2:251);
        ...
        set(TT,'fontsize',12)
        TT = text(5,-.15,sprintf('KE = %5.2f meV',KE*1e3));
        set(TT,'fontsize',12)
